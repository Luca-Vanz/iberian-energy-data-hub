...
def test_public_dashboard() -> None:
    ...
    required_download_features = [
        ...
        'id="seriesWarnings"',
        "function renderSeriesWarnings(result)",
        "definitionCounts",
        "official gaps remain blank",
        "Available series —",
        "native ${resolutions}",
    ...
    required_formula_features = [
        ...
        'id="formulaLegend"',
        'id="formulaStatus"',
        'data-formula-template="sum"',
        'data-formula-template="difference"',
        'data-formula-template="average"',
        "function insertFormulaText(",
