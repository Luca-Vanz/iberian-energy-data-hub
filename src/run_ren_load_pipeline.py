...
from src.collectors.ren_demand import (
    download_ren_demand,
)
from src.database.load_electricity_load import (
    create_electricity_load_table,
    load_ren_demand,
)
from src.processing.parse_ren_demand import (
    process_ren_demand,
)
...
def save_failure_log(
    ...
    with log_path.open(
        ...
        file.write(
            "REN load pipeline failure report\n"
        )
...
def run_pipeline(
    ...
    print(
        f"Running REN load pipeline from "
